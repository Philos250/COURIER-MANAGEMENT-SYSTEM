            ...
            <form action="search-courier.php" method="post">
              <div class="form-row">
                <div class="col-12 col-md-9 mb-2 mb-md-0">
                  <input name="Consignment" type="text" class="form-control form-control-lg" placeholder="Enter the Consignment No...">
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 h-100 text-center text-lg-left my-auto">
            ...
            <p class="text-muted small mb-4 mb-lg-0">&copy; waka, Courier Management System 2018. All Rights Reserved.</p>
          </div>
