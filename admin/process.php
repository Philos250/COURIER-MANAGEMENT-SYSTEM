...
function addCons(){
	...
	$sql = "INSERT INTO tbl_courier (cons_no, ship_name, phone, s_add, rev_name, r_phone, r_add, dname, plaque, type, qty, book_mode, Totalfreight, mode, office, pick_date, pick_time, status, comments, book_date )
			VALUES('$ConsignmentNo', '$Shippername','$Shipperphone', '$Shipperaddress', '$Receivername','$Receiverphone','$Receiveraddress', '$drivername', '$plaque', '$Shiptype', $Qnty, '$Bookingmode', '$Totalfreight', '$Mode', '$office', '$Packupdate', '$Pickuptime', '$status', '$Comments', NOW())";	
	//echo $sql;
	dbQuery($sql);
