    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a class="active" href="#">Update Courier</a>
                </li>
                <li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Update Courier</h1>
                <p></p>
                <a href="#menu-toggle" class="btn btn-info" id="menu-toggle">Click to Get Menu</a>
				<a href="#" class="btn btn-info" style="margin-left:10px;">Update Courier</a>
            </div>
<?php 
include 'dbcon.php';
			...
			<div class="col-md-12">
					<div class="panel panel-default">
					  <div class="panel-heading main-color-bg">
						<h3 class="panel-title">You have <?php echo $field['m'];?> Courier</h3>
					  </div>
					  	<div class="panel-body">
							<div class="row">
							<div class="col-md-9">
								<input class="form-control input-type-space" type="text" name="" placeholder="Filter Courier......">
							</div><!--end of col-->
							<div class="col-md-3">
